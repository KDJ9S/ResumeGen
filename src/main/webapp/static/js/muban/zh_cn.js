...
(function (factory) {
    ...
    $.FE.LANGUAGE['zh_cn'] = {
        translation: {
            ...
            "Image Caption": "鍥剧墖璇存槑",
            "Advanced Edit": "楂樼骇缂栬緫",
            ...
            "Emoticons": "\u8868\u60c5",
            "Grinning face": "\u8138\u4e0a\u7b11\u563b\u563b",
            "Grinning face with smiling eyes": "鍜х潃鍢寸瑧鐨勮劯寰瑧鐨勭溂鐫�",
            ...
            "Hushed face": "\u5b89\u9759\u7684\u8138",
            "Face with open mouth and cold sweat": "鑴镐笂闇插嚭鍢村反鍜屽喎姹�",
            ...
            // Spell Checker.
            "Spell Checker": "鎷煎啓妫€鏌ュ櫒",

            // Help
            "Help": "甯府鎴�",
            "Shortcuts": "蹇嵎閿�",
            "Inline Editor": "鍐呰仈缂栬緫鍣�",
            "Show the editor": "鏄剧ず缂栬緫",
            "Common actions": "鍏卞悓琛屽姩",
            "Copy": "澶嶅埗",
            "Cut": "鍒�",
            "Paste": "绯�",
            "Basic Formatting": "鍩烘湰鏍煎紡",
            "Increase quote level": "鎻愰珮鎶ヤ环姘村钩",
            "Decrease quote level": "闄嶄綆鎶ヤ环姘村钩",
            "Image / Video": "鍥惧儚/瑙嗛",
            "Resize larger": "璋冩暣澶у皬鏇村ぇ",
            "Resize smaller": "璋冩暣澶у皬鏇村皬",
            "Table": "琛�",
            "Select table cell": "閫夋嫨琛ㄥ崟鍏冩牸",
            "Extend selection one cell": "鎵╁睍閫夋嫨涓€涓崟鍏冩牸",
            "Extend selection one row": "鎵╁睍閫夋嫨涓€琛�",
            "Navigation": "瀵艰埅",
            "Focus popup / toolbar": "鐒︾偣寮瑰嚭/宸ュ叿鏍�",
            "Return focus to previous position": "灏嗙劍鐐硅繑鍥炲埌涓婁竴涓綅缃�",

            // Embed.ly
            "Embed URL": "宓屽叆缃戝潃",
            "Paste in a URL to embed": "绮樿创鍦ㄤ竴涓綉鍧€涓祵鍏�",

            // Word Paste.
            "The pasted content is coming from a Microsoft Word document. Do you want to keep the format or clean it up?": "绮樿创鐨勫唴瀹规潵鑷井杞疻ord鏂囨。銆備綘鎯充繚鐣欐牸寮忚繕鏄竻鐞嗗畠锛�",
            "Keep": "淇濇寔",
            "Clean": "娓呮磥",
            "Word Paste Detected": "妫€娴嬪埌瀛楄创"
        },
        direction: "ltr"
    };
